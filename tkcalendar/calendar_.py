...
# top = Tk()
# cal = Calendar(top, font="Arial 14", selectmode='day', locale='en_US', firstweekday = 'sunday',
#                 weekenddays = [6,7], disabledforeground='red',
#                 cursor="hand1")
# cal.pack(fill="both", expand=True)
# ttk.Button(top, text="OK", command=None).pack()
